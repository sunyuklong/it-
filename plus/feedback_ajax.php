...
else if($dopost=='send')
{
    ...
    if(!empty($fid))
    {
        $row = $dsql->GetOne("SELECT username,msg,ip from `#@__feedback` WHERE id ='$fid' ");
...
echo $result;?>网友 回复于<?php echo GetDateMk($dtime); ?>
    ...
    <span class="comm_reply"><a style="cursor:pointer" id='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);">支持(0)</a><span class="v">|</span><a style="cursor:pointer" id='#badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);">反对(0)</a><span class="v">|</span><a href='javascript:ajaxFeedback(<?php echo $id; ?>,<?php echo $id; ?>,"quote");ShowReplay(<?php echo $id; ?>,71269) ;'>回复</a></span>
    </div>
...
echo $result;?>网友 回复于<?php echo GetDateMk($dtime); ?>
	...
	?>
    <?php echo ubb($msg); ?></p>
    <span class="comm_reply"><a style="cursor:pointer" id="goodfb<?php echo $id; ?>" onclick="postBadGood('goodfb',<?php echo $id; ?>);">支持(<?php echo $good; ?>)</a><span class="v">|</span><a style="cursor:pointer" id="badfb<?php echo $id; ?>" onclick="postBadGood('badfb',<?php echo $id; ?>);">反对(<?php echo $bad; ?>)</a><span class="v">|</span><a href='javascript:ajaxFeedback(<?php echo $id; ?>,<?php echo $id; ?>,"quote");ShowReplay(<?php echo $id; ?>,71269) ;'>回复</a></span>
    </div>
    <div id="ajaxfeedback_<?php echo $id; ?>"></div>
    </li>
