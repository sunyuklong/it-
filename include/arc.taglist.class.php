...
class TagList
{
    ...
    function GetPageListDM($list_len,$listitem="info,index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $prepage.="<a class=\"pagenew\" href='".$purl."/$prepagenum/'><</a>";		
            $indexpage="<a class=\"pagenew\" href='".$purl."/1/'><<</a>";			
        }
        else
        {
        ...
        {
            $nextpage.="<a class=\"pagenew\" href='".$purl."/$nextpagenum/'>></a>";	
            $endpage="<a class=\"pagenew\" href='".$purl."/$totalpage/'>>></a>";			
        }
        else
        {
        ...
        for($j; $j<=$total_list; $j++)
        {
            ...
            {
               $listdd.="<a href='".$purl."/$j/' class=\"pagenew\">".$j."</a>";
            }
        }
        $plist  =  '';
