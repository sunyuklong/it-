...
{
    $quote = str_replace('{quote}','<ul class="reply"><li class="gh">',$quote);
    $quote = str_replace('{title}','<div class="re_info"><strong>',$quote);
    $quote = str_replace('{/title}','</strong></div>',$quote);
    $quote = str_replace('&lt;br/&gt;','<br>',$quote);
    $quote = str_replace('&lt;', '<', $quote);
    $quote = str_replace('&gt;', '>', $quote);
    $quote = str_replace('{content}','<div class="re_comm"><p>',$quote);
    $quote = str_replace('{/content}','</p><span class="comm_reply"> </span></div>',$quote);
    $quote = str_replace('{/quote}','</li></ul><div class="comm"><p>',$quote);
    return $quote;
}
