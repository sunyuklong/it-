...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $prepage.="<a class=\"pagenew\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'><</a>";			
            $indexpage="<a class=\"pagenew\" href='".str_replace("{page}",1,$tnamerule)."'><<</a>";
        }
        else
        {
            $indexpage="<a disabled=\"disabled\"><</a>";
        }
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $nextpage.="<a class=\"pagenew\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>></a>";			
            $endpage="<a class=\"pagenew\" href='".str_replace("{page}",$totalpage,$tnamerule)."'>>></a>";
        }
        else
        {
            $endpage="<a disabled=\"disabled\">></a>";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {				
                $listdd.="<a href='".str_replace("{page}",$j,$tnamerule)."' class=\"pagenew\">".$j."</a>";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {						
            $prepage.="<a class=\"pagenew\" href='".$purl."PageNo=$prepagenum'><</a>";		
            $indexpage="<a class=\"pagenew\" href='".$purl."PageNo=1'><<</a>";
        }
        else
        {
            $indexpage="<a disabled=\"disabled\"><</a>";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $nextpage.="<a class=\"pagenew\" href='".$purl."PageNo=$nextpagenum'>></a>";	
            $endpage="<a class=\"pagenew\" href='".$purl."PageNo=$totalpage'>>></a>";
        }
        else
        {
            $endpage="<a disabled=\"disabled\">></a>";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {				
                $listdd.="<a href='".$purl."PageNo=$j' class=\"pagenew\">".$j."</a>";
            }
        }
